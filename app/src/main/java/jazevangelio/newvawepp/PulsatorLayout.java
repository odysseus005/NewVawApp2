...
public class PulsatorLayout extends RelativeLayout {
    ...
    public PulsatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attr = context.getTheme().obtainStyledAttributes(
                attrs, pl.bclogic.pulsator4droid.library.R.styleable.Pulsator4Droid, 0, 0);
        ...
        try {
            mCount = attr.getInteger(pl.bclogic.pulsator4droid.library.R.styleable.Pulsator4Droid_pulse_count, DEFAULT_COUNT);
            mDuration = attr.getInteger(pl.bclogic.pulsator4droid.library.R.styleable.Pulsator4Droid_pulse_duration,
                    DEFAULT_DURATION);
            mRepeat = attr.getInteger(pl.bclogic.pulsator4droid.library.R.styleable.Pulsator4Droid_pulse_repeat, DEFAULT_REPEAT);
            mStartFromScratch = attr.getBoolean(pl.bclogic.pulsator4droid.library.R.styleable.Pulsator4Droid_pulse_startFromScratch,
                    DEFAULT_START_FROM_SCRATCH);
            mColor = attr.getColor(pl.bclogic.pulsator4droid.library.R.styleable.Pulsator4Droid_pulse_color, DEFAULT_COLOR);
            mInterpolator = attr.getInteger(pl.bclogic.pulsator4droid.library.R.styleable.Pulsator4Droid_pulse_interpolator,
     ...
     * @param v
     */
    public int getDuration(double v) {
        return mDuration;
    }
